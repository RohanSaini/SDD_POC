...
// const Handlebars = require('../../assets/scripts/handlebars.min-v4.5.3');
// console.log('showdown', window.location);
...
const incoming_msg_template = `
<div class="message {{message.type}}">
	<div class="message-avatar-container">
		<img src=".\\assets\\images\\indian-army.png">
	</div>
	<div class="message-content-container">
		...
		{{else}}
			<h4 class="message-title">Indian Army Legal Assistant</h4>
		{{/if}}
...
var Botkit = {
  ...
  boot: function(user) {
    ...
    that.message_template = Handlebars.compile(msg_template);
    that.incoming_msg_template = Handlebars.compile(incoming_msg_template);
